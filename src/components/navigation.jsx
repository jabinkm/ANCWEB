...
export function Navigation() {
  ...
  return (
    ...
    //           className="p-1 font-normal"
    //         >
    //           <Link to={"/#about"} className="flex items-center text-gray-700 hover:text-red-600">
    //             ABOUT US
    //           </Link>
    //         </Typography>
    //         <Typography
    ...
    //           className="p-1 font-normal"
    //         >
    //           <Link to={"#services"} className="flex items-center text-gray-700 hover:text-red-600">
    //             DIVISIONS
    //           </Link>
    //         </Typography>
    //         <Typography
    ...
    //         className="p-1 font-normal"
    //       >
    //         <Link to={"#services"} className="flex items-center text-gray-700 hover:text-red-600" onClick={() => setIsOpen(false)}>
    //           DIVISIONS
    //         </Link>
    //       </Typography>
    //       <Typography
    ...
    //       </Typography>
    //     </ul>
    //     <Button className="mb-2 bg-red-600 text-white px-6 py-2 rounded-full hover:bg-red-700 transition duration-300">
    //       GET A QUOTE
    //     </Button>
    //   </Collapse>
    // </Navbar>
